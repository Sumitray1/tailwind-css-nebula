...
function MarketingStrg() {
  ...
  return (
    <div>
      <h1 className=" text-primary text-4xl font-semibold mb-14">
        Are you looking for a way to boost the growth of your business?
      </h1>
      <h1 className="text-primary text-6xl font-semibold mb-14">
        Team <span className="text-secondary">Nebula</span> is here ...
      </h1>
      <p className="text-gray-600 text-xl mb-14">
      ...
      <div className="grid grid-cols-2 gap-x-36 gap-y-16 mb-14">
